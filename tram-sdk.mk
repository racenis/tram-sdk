...
LinkOptions            :=  -ld3d9 -lSDL2.dll -lglfw3 -lgdi32 -lopengl32 -lportaudio -lwinmm -lole32
...
## Objects
##
$(IntermediateDirectory)/src_render_direct3d_renderer.cpp$(ObjectSuffix): src/render/direct3d/renderer.cpp $(IntermediateDirectory)/src_render_direct3d_renderer.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/Poga/Desktop/painis/tram-sdk/src/render/direct3d/renderer.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_render_direct3d_renderer.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_render_direct3d_renderer.cpp$(DependSuffix): src/render/direct3d/renderer.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_render_direct3d_renderer.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/src_render_direct3d_renderer.cpp$(DependSuffix) -MM src/render/direct3d/renderer.cpp

$(IntermediateDirectory)/src_render_direct3d_renderer.cpp$(PreprocessSuffix): src/render/direct3d/renderer.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_render_direct3d_renderer.cpp$(PreprocessSuffix) src/render/direct3d/renderer.cpp
