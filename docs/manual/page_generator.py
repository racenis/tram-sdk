...
pages = ["index", "overview", "gettingstarted",
		 "entity", "entitycomponent", "event", "message", "worldcell", "core", "resource",
		 "render", "armature", "async", "ui", "gui",
		 "rendercomponent", "armaturecomponent", "lightcomponent", "physicscomponent", "playercomponent",
		 "staticworldobject", "crate", "light", "player"]
template = "template"
