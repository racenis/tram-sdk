...
namespace Core::Render {
    ...
    void CompileShaders(){
        ...
        auto normal_dynamic_vertex =         new VertexShader("shaders/gles3/normal_dynamic.vert", Model::DYNAMIC_VERTEX);
        auto normal_dynamic_fragment =       new FragmentShader("shaders/gles3/normal_dynamic.frag", Material::TEXTURE);
        auto normal_water_fragment =         new FragmentShader("shaders/gles3/normal_water.frag", Material::TEXTURE_WATER);
        auto line_vertex =                   new VertexShader("shaders/gles3/line.vert", Model::LINE_VERTEX);
        auto line_fragment =                 new FragmentShader("shaders/gles3/line.frag", Material::FLAT_COLOR);
        auto text_vertex =                   new VertexShader("shaders/gles3/text.vert", Model::TEXT_VERTEX);
