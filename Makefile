...
src_audio_spatial_output.o: ./src/audio/spatial/output.cpp
	gcc -c -g -O0 -std=c++20 -I./src -Ilibraries -Ilibraries/bullet -Ilibraries/glad -Ilibraries/glfw3 -Ilibraries/openal ./src/audio/spatial/output.cpp -o src_audio_spatial_output.o

src_audio_spatial_pathtracer.o: ./src/audio/spatial/pathtracer.cpp
	gcc -c -g -O0 -std=c++20 -I./src -Ilibraries -Ilibraries/bullet -Ilibraries/glad -Ilibraries/glfw3 -Ilibraries/openal ./src/audio/spatial/pathtracer.cpp -o src_audio_spatial_pathtracer.o

src_audio_spatial_spatial.o: ./src/audio/spatial/spatial.cpp
	gcc -c -g -O0 -std=c++20 -I./src -Ilibraries -Ilibraries/bullet -Ilibraries/glad -Ilibraries/glfw3 -Ilibraries/openal ./src/audio/spatial/spatial.cpp -o src_audio_spatial_spatial.o
...
clean:
	...
	del src_audio_spatial_output.o
	del src_audio_spatial_pathtracer.o
	del src_audio_spatial_spatial.o
