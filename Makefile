...
src_entities_trigger.o: ./src/entities/trigger.cpp
	gcc -c -g -O0 -std=c++20 -I./src -Ilibraries -Ilibraries/bullet -Ilibraries/glad -Ilibraries/glfw3 -Ilibraries/openal ./src/entities/trigger.cpp -o src_entities_trigger.o
...
src_extensions_kitchensink_soundtable.o: ./src/extensions/kitchensink/soundtable.cpp
	gcc -c -g -O0 -std=c++20 -I./src -Ilibraries -Ilibraries/bullet -Ilibraries/glad -Ilibraries/glfw3 -Ilibraries/openal ./src/extensions/kitchensink/soundtable.cpp -o src_extensions_kitchensink_soundtable.o
...
src_extensions_scripting_lua.o: ./src/extensions/scripting/lua.cpp
	gcc -c -g -O0 -std=c++20 -I./src -Ilibraries -Ilibraries/bullet -Ilibraries/glad -Ilibraries/glfw3 -Ilibraries/openal ./src/extensions/scripting/lua.cpp -o src_extensions_scripting_lua.o
...
src_framework_script.o: ./src/framework/script.cpp
	gcc -c -g -O0 -std=c++20 -I./src -Ilibraries -Ilibraries/bullet -Ilibraries/glad -Ilibraries/glfw3 -Ilibraries/openal ./src/framework/script.cpp -o src_framework_script.o

src_framework_signal.o: ./src/framework/signal.cpp
	gcc -c -g -O0 -std=c++20 -I./src -Ilibraries -Ilibraries/bullet -Ilibraries/glad -Ilibraries/glfw3 -Ilibraries/openal ./src/framework/signal.cpp -o src_framework_signal.o
...
src_platform_glfw_glfw.o: ./src/platform/glfw/glfw.cpp
	gcc -c -g -O0 -std=c++20 -I./src -Ilibraries -Ilibraries/bullet -Ilibraries/glad -Ilibraries/glfw3 -Ilibraries/openal ./src/platform/glfw/glfw.cpp -o src_platform_glfw_glfw.o
